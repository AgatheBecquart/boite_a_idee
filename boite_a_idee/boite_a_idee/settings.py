...
ALLOWED_HOSTS = ['0.0.0.0', '20.74.92.51', 'boiteagathe.francecentral.azurecontainer.io']
...
ROOT_URLCONF = 'boite_a_idee.urls'
...
WSGI_APPLICATION = 'boite_a_idee.wsgi.application'
